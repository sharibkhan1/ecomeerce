...
const StoreNavBar = async () => {
  ...
  return (
    <div className='border-b sticky top-0 left-0 z-50 bg-black/90 ' >
            <div className='relative px-4 sm:px-6 lg:px-8 hidden  md:flex h-16 items-center ' >
            ...
            <div className='relative px-4 sm:px-6 lg:px-8 md:hidden flex h-16 items-center justify-between ' >
